...
This framework is using Maven as build tool.
TestNG is used as test tool.
Rest-Assured is used as rest client.
Allure used for reporting. It can be also used for BDD format.
Hamcrest is used for assertions.
